...
const dictionary: Record<string, { id: string; en: string }> = {
  ...
  "Manajemen Admin": { id: "Manajemen Admin", en: "Admin Management" },
  "Owner membuat dan mengelola akun admin UMKM/cabang.": {
    id: "Owner membuat dan mengelola akun admin UMKM/cabang.",
    en: "Owner creates and manages store/branch admin accounts.",
  },
  ...
  "Gagal memuat admin": { id: "Gagal memuat admin", en: "Failed to load admins" },
  "Nama, username, email, password, dan nama UMKM wajib diisi.": {
    id: "Nama, username, email, password, dan nama UMKM wajib diisi.",
    en: "Admin name, username, email, password, and store name are required.",
  },
  "Username minimal 3 karakter. Gunakan huruf, angka, atau underscore.": {
    id: "Username minimal 3 karakter. Gunakan huruf, angka, atau underscore.",
    en: "Username must be at least 3 characters. Use letters, numbers, or underscores.",
  },
  "Admin berhasil dibuat. Username login:": { id: "Admin berhasil dibuat. Username login:", en: "Admin created. Login username:" },
  "Gagal membuat admin": { id: "Gagal membuat admin", en: "Failed to create admin" },
  "File QRIS harus berupa gambar PNG/JPG.": { id: "File QRIS harus berupa gambar PNG/JPG.", en: "QRIS file must be a PNG/JPG image." },
  "Nama UMKM wajib diisi.": { id: "Nama UMKM wajib diisi.", en: "Store name is required." },
  "Data admin, nama UMKM, dan QRIS statis berhasil diperbarui.": {
    id: "Data admin, nama UMKM, dan QRIS statis berhasil diperbarui.",
    en: "Admin data, store name, and static QRIS were updated.",
  },
  "Gagal menyimpan perubahan admin": { id: "Gagal menyimpan perubahan admin", en: "Failed to save admin changes" },
  "Admin berhasil diaktifkan kembali.": { id: "Admin berhasil diaktifkan kembali.", en: "Admin has been activated again." },
  "Admin berhasil dinonaktifkan.": { id: "Admin berhasil dinonaktifkan.", en: "Admin has been deactivated." },
  "Gagal mengaktifkan admin": { id: "Gagal mengaktifkan admin", en: "Failed to activate admin" },
  "Gagal menonaktifkan admin": { id: "Gagal menonaktifkan admin", en: "Failed to deactivate admin" },
  "Kasir berhasil disetujui dan sudah bisa login.": {
    id: "Kasir berhasil disetujui dan sudah bisa login.",
    en: "Cashier approved and can now log in.",
  },
  "Gagal approve kasir": { id: "Gagal approve kasir", en: "Failed to approve cashier" },
  "Approval Kasir Tambahan": { id: "Approval Kasir Tambahan", en: "Additional Cashier Approval" },
  "Kasir kedua dan seterusnya perlu persetujuan owner sebelum bisa login.": {
    id: "Kasir kedua dan seterusnya perlu persetujuan owner sebelum bisa login.",
    en: "The second cashier and beyond need owner approval before logging in.",
  },
  "Dibuat Oleh": { id: "Dibuat Oleh", en: "Created By" },
  "Menunggu Approval": { id: "Menunggu Approval", en: "Waiting Approval" },
  Ditolak: { id: "Ditolak", en: "Rejected" },
  "Admin Nonaktif": { id: "Admin Nonaktif", en: "Admin Inactive" },
  Approve: { id: "Setujui", en: "Approve" },
  "Tambahkan Admin UMKM": { id: "Tambahkan Admin UMKM", en: "Add Store Admin" },
  "Isi data admin, toko, kontak, dan masa aktif subscription dalam satu form.": {
    id: "Isi data admin, toko, kontak, dan masa aktif subscription dalam satu form.",
    en: "Fill admin, store, contact, and subscription expiry data in one form.",
  },
  "Gunakan huruf kecil, angka, atau underscore. Contoh: admin_cabang_4": {
    id: "Gunakan huruf kecil, angka, atau underscore. Contoh: admin_cabang_4",
    en: "Use lowercase letters, numbers, or underscores. Example: admin_branch_4",
  },
  "Nama UMKM/Cabang": { id: "Nama UMKM/Cabang", en: "Store/Branch Name" },
  "Alamat Cabang": { id: "Alamat Cabang", en: "Branch Address" },
  "Nomer Telpon": { id: "Nomer Telpon", en: "Phone Number" },
  "Masa Aktif Sampai": { id: "Masa Aktif Sampai", en: "Active Until" },
  "Kosongkan jika admin tidak memakai batas subscription.": {
    id: "Kosongkan jika admin tidak memakai batas subscription.",
    en: "Leave empty if this admin has no subscription limit.",
  },
  "Buat Admin": { id: "Buat Admin", en: "Create Admin" },
  "QRIS statis per cabang bisa ditambahkan setelah admin dibuat lewat tombol Edit.": {
    id: "QRIS statis per cabang bisa ditambahkan setelah admin dibuat lewat tombol Edit.",
    en: "Static QRIS per branch can be added after the admin is created using Edit.",
  },
  "Daftar Admin": { id: "Daftar Admin", en: "Admin List" },
  "Kelola akun cabang, nama UMKM, QRIS statis, dan saldo QRIS Pakasir.": {
    id: "Kelola akun cabang, nama UMKM, QRIS statis, dan saldo QRIS Pakasir.",
    en: "Manage branch accounts, store names, static QRIS, and Pakasir QRIS balance.",
  },
  "Memuat admin...": { id: "Memuat admin...", en: "Loading admins..." },
  "Alamat Toko": { id: "Alamat Toko", en: "Store Address" },
  "Tanpa alamat": { id: "Tanpa alamat", en: "No address" },
  "Masa Aktif": { id: "Masa Aktif", en: "Active Period" },
  "Tanpa batas": { id: "Tanpa batas", en: "No limit" },
  "Saldo QRIS Pakasir": { id: "Saldo QRIS Pakasir", en: "Pakasir QRIS Balance" },
  "Total Withdrawn": { id: "Total Ditarik", en: "Total Withdrawn" },
  "Belum ada": { id: "Belum ada", en: "Not set" },
  "Ada QRIS": { id: "Ada QRIS", en: "QRIS Added" },
  "Daftar Akun Kasir": { id: "Daftar Akun Kasir", en: "Cashier Account List" },
  "Semua kasir yang dibuat admin. Jika admin nonaktif atau expired, kasir otomatis ikut tidak bisa login.": {
    id: "Semua kasir yang dibuat admin. Jika admin nonaktif atau expired, kasir otomatis ikut tidak bisa login.",
    en: "All cashiers created by admins. If the admin is inactive or expired, their cashiers cannot log in automatically.",
  },
  "Belum ada akun kasir yang dibuat admin.": {
    id: "Belum ada akun kasir yang dibuat admin.",
    en: "No cashier accounts created by admins yet.",
  },
  "Admin Pembuat": { id: "Admin Pembuat", en: "Created By Admin" },
  "Status Kasir": { id: "Status Kasir", en: "Cashier Status" },
  "Status Admin": { id: "Status Admin", en: "Admin Status" },
  "Masa aktif:": { id: "Masa aktif:", en: "Active until:" },
  "Edit Admin UMKM": { id: "Edit Admin UMKM", en: "Edit Store Admin" },
  "Edit nama UMKM dan QRIS statis yang akan tampil di pembayaran QRIS Statis milik admin ini.": {
    id: "Edit nama UMKM dan QRIS statis yang akan tampil di pembayaran QRIS Statis milik admin ini.",
    en: "Edit the store name and static QRIS shown in this admin's Static QRIS payment.",
  },
  "Masa Aktif Subscription": { id: "Masa Aktif Subscription", en: "Subscription Active Until" },
  "Kalau tanggal lewat, admin otomatis tidak bisa login/akses dashboard. Kosongkan untuk tanpa batas.": {
    id: "Kalau tanggal lewat, admin otomatis tidak bisa login/akses dashboard. Kosongkan untuk tanpa batas.",
    en: "After this date passes, the admin cannot log in or access the dashboard. Leave empty for no limit.",
  },
  "QRIS Statis Pemilik UMKM": { id: "QRIS Statis Pemilik UMKM", en: "Store Owner Static QRIS" },
  "Upload QRIS statis cabang": { id: "Upload QRIS statis cabang", en: "Upload branch static QRIS" },
  "Gambar ini akan muncul saat admin memilih QRIS Statis di POS.": {
    id: "Gambar ini akan muncul saat admin memilih QRIS Statis di POS.",
    en: "This image appears when the admin chooses Static QRIS in POS.",
  },
  "Upload / Ganti QRIS": { id: "Upload / Ganti QRIS", en: "Upload / Replace QRIS" },
